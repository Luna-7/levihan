...
describe('security boundaries', () => {
  ...
  it('rejects missing required configuration', () => {
    ...
    expect(parseConfig({ NODE_ENV: 'production', API_ALLOWED_ORIGINS: 'https://app.example.test', SESSION_HASH_PEPPER: 'a'.repeat(32), AUTH_HASH_PEPPER: 'b'.repeat(32), CLOUDBASE_APIKEY: apiKey, COS_PUBLIC_BUCKET: 'public-bucket', COS_PRIVATE_BUCKET: 'private-bucket', COS_REGION: 'ap-test-1', DATABASE_SCHEMA: 'public' }).sessionCookieDomain).toBeUndefined();
  });
  ...
  it('rejects short peppers and disabled production CSRF', () => {
    ...
    expect(() => parseConfig({ ...base, SESSION_HASH_PEPPER: 'a'.repeat(32), AUTH_HASH_PEPPER: 'b'.repeat(32), TRUST_PROXY_HEADERS: 'true' })).toThrow(/API_PROXY_HMAC_SECRET/);
  });
