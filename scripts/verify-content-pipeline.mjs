...
const ROUTINES = [
  ['create_work_draft', 'text,text,text,text,text,text,uuid,text'],
  ['update_work_draft', 'uuid,bigint,jsonb,jsonb,uuid,text'],
  ['transition_work_state', 'uuid,bigint,text,text,text,uuid,text'],
  ['create_work_upload', 'uuid,uuid,uuid,uuid,uuid,text,bigint,text,text,text,integer,text,timestamptz,text'],
  ['get_work_upload_for_completion', 'uuid,uuid'],
  ['complete_work_upload', 'uuid,uuid,uuid,uuid,uuid,text,bigint,text,text,text,text,integer,text,text'],
  ['begin_snapshot_build', 'text,uuid,text'], ['list_public_catalog', ''],
...
export function validateContentPipeline({ migration, rollback, access }) {
  const failures = [];
