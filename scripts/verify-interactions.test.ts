...
describe('interaction migration verifier', () => {
  ...
  it.each([
    ...
    ['runtime direct DML revoke', (v: ReturnType<typeof files>) => { v.access = v.access.replace('REVOKE ALL ON TABLE public.work_likes,public.favorites,public.comments,public.reading_progress,public.reports', ''); }],
