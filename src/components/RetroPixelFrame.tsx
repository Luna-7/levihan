...
export const RetroPixelFrame: React.FC<Props> = ({
  ...
  return (
    <div className="w-full max-w-4xl mx-auto my-4 sm:my-8 px-2 sm:px-4">
      {/* Outer Card with Stitched Border & Corner Pixel Hearts */}
      <div className="relative bg-[#FBF7EC] border-4 border-[#1E4334] rounded-lg p-3 sm:p-6 shadow-xl">
        {/* Inner Gold/Brown Stitched Dotted Line */}
        <div className="absolute inset-2 border-2 border-dashed border-[#D4B26F] pointer-events-none rounded-md" />
        ...
        <footer className="mt-4 pt-3 border-t-2 border-dashed border-[#D5C9AF] text-center">
          <div className="bg-[#1E4334] text-[#FAF5E8] px-3 py-2 rounded-xs flex flex-col sm:flex-row items-center justify-between gap-2 shadow-xs">
            <div className="flex items-center gap-1.5 font-pixel text-xs text-[#F9E79F] font-bold">
              <span>🥔 利韩土豆群</span>
              <span className="text-[#FAF5E8] font-normal">· 调查兵团粮仓</span>
            </div>

            <div className="font-retro-jp text-[11px] text-[#D5F5E3] tracking-wide">
              ✦ 利韩专一向同好交流 · 严禁商用倒卖与公开二传 ✦
            </div>

            <div className="flex items-center gap-1.5">
              <span className="text-[10px] font-pixel text-[#EAA83B]">心臓を捧げよ</span>
