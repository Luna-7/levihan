...
GRANT EXECUTE ON FUNCTION
  public.create_work_draft(text,text,text,text,text,text,uuid,text),
  public.update_work_draft(uuid,bigint,jsonb,jsonb,uuid,text),
  public.transition_work_state(uuid,bigint,text,text,text,uuid,text),
  public.create_work_upload(uuid,uuid,uuid,uuid,uuid,text,bigint,text,text,text,integer,text,timestamptz,text),
  public.get_work_upload_for_completion(uuid,uuid),
  public.complete_work_upload(uuid,uuid,uuid,uuid,uuid,text,bigint,text,text,text,text,integer,text,text),
  public.begin_snapshot_build(text,uuid,text), public.list_public_catalog(),
