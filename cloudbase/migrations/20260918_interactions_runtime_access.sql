...
\endif
BEGIN;
REVOKE ALL ON TABLE public.work_likes,public.favorites,public.comments,public.comment_idempotency,public.reading_progress,public.reports,public.moderation_actions,public.audit_logs FROM :"backend_role";
