...
REVOKE EXECUTE ON FUNCTION
  ...
  public.create_work_upload(uuid,uuid,uuid,uuid,uuid,text,bigint,text,text,text,integer,text,timestamptz,text,text),
  public.get_work_upload_for_completion(uuid,uuid),
  public.complete_work_upload(uuid,uuid,uuid,uuid,uuid,text,text,text,bigint,text,text,text,text,integer,text,text),
