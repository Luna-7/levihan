...
DROP FUNCTION IF EXISTS public.complete_work_upload(uuid,uuid,uuid,uuid,uuid,text,text,text,bigint,text,text,text,text,integer,text,text);
DROP FUNCTION IF EXISTS public.get_work_upload_for_completion(uuid,uuid);
DROP FUNCTION IF EXISTS public.create_work_upload(uuid,uuid,uuid,uuid,uuid,text,bigint,text,text,text,integer,text,timestamptz,text,text);
