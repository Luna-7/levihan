...
FROM :"backend_role";
GRANT SELECT ON TABLE public.work_likes,public.favorites,public.comments,public.reading_progress,public.reports,public.moderation_actions,public.audit_logs TO :"backend_role";
GRANT INSERT ON TABLE public.comments,public.reports,public.moderation_actions,public.audit_logs TO :"backend_role";
GRANT UPDATE ON TABLE public.comments,public.reports TO :"backend_role";
GRANT EXECUTE ON FUNCTION public.set_work_like(uuid,uuid,boolean),public.set_favorite(uuid,uuid,boolean),public.sync_reading_progress(uuid,uuid,bigint,numeric,bigint,timestamptz) TO :"backend_role";
COMMIT;
