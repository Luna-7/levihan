...
GRANT EXECUTE ON FUNCTION public.answer_registration_challenge(uuid, boolean, integer, integer, text, timestamptz),
  ...
  public.consume_registration_ticket(text, text, text, text, text, text),
  public.create_login_session(uuid, text, text, text),
  public.rotate_user_session(text, text, text),
  public.consume_recovery_code(text, text, text, text, text),
  public.get_unconfirmed_recovery_credential(text),
  public.regenerate_unconfirmed_recovery_code(text,text,text,text),
